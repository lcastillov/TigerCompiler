...
{
    class LThanNode : OrderNode
    {
        public LThanNode() : base() { }

        public LThanNode(IToken token) : base(token) { }

        public LThanNode(LThanNode node) : base(node) { }
        ...
        public override void GenerateCode(ModuleBuilder moduleBuilder, TypeBuilder program, ILGenerator generator)
        {
                ...
                this.RightOperandNode.ExpressionType == PredefinedTypes.StrType)
            {
                ...
                generator.Emit(OpCodes.Blt, LBL); //1 Si c < 0
                generator.Emit(OpCodes.Ldc_I4, 0);
